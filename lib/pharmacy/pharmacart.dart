...
import 'package:jhatfat/bean/resturantbean/restaurantcartitem.dart';
import 'package:jhatfat/databasehelper/dbhelper.dart';
import 'package:jhatfat/pharmacy/pharmapaymentpage.dart';
      ...
      if (value.statusCode == 200) {
        ...
        if (jsonData['status'] == "1" && jsonData['data']!=null && jsonData['data']!='null') {
          ...
          if(addressWelcome.data!=null){
            ...
            Toast.show("Address not found!", duration: Toast.lengthShort, gravity:  Toast.bottom);
          }
        } else {
          setState(() {
            isCartFetch = false;
...
//        print('resp value - ${value.body}');
        ...
        if (addressDelivery != null) {
          Toast.show('Please add something in your cart to proceed!',  duration: Toast.lengthShort, gravity:  Toast.bottom);
        } else {
      ...
      Toast.show('Please add some items into cart!', duration: Toast.lengthShort, gravity:  Toast.bottom);
    }
  }
